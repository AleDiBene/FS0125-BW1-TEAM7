function generateResults(correctAnswers, totalQuestions) {
  ...
  document.getElementById(
    "correct-text"
  ).innerText = `Correct: ${correctPercentage.toFixed(
    1
  )}% (${correctAnswers}/${totalQuestions} questions)`;
  document.getElementById(
    "wrong-text"
  ).innerText = `Wrong: ${wrongPercentage.toFixed(1)}% (${
  ...
  correctCircle.style.strokeDashoffset =
    circumference * (1 - correctPercentage / 100);
